...
#include "../../App/PiClockLib/managers/widgetmanager.h"
...
QT_MOC_LITERAL(1, 14, 17), // "changeWidgetSlide"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 5), // "start"
QT_MOC_LITERAL(4, 39, 4), // "stop"
QT_MOC_LITERAL(5, 44, 9) // "nextSlide"

    },
    "WidgetManager\0changeWidgetSlide\0\0start\0"
    "stop\0nextSlide"
};
...
void WidgetManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changeWidgetSlide((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            using _t = void (WidgetManager::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WidgetManager::changeWidgetSlide)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject WidgetManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_WidgetManager.data,
      qt_meta_data_WidgetManager,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void WidgetManager::changeWidgetSlide(int _t1)
{
