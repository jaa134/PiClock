...
public:
    ...
    void setupUi(QWidget *SystemStatisticsWidget)
    {
        if (SystemStatisticsWidget->objectName().isEmpty())
            SystemStatisticsWidget->setObjectName(QString::fromUtf8("SystemStatisticsWidget"));
        ...
        discLabel->setObjectName(QString::fromUtf8("discLabel"));
