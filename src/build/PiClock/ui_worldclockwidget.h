...
public:
    ...
    void setupUi(QWidget *WorldClockWidget)
    {
        if (WorldClockWidget->objectName().isEmpty())
            WorldClockWidget->setObjectName(QString::fromUtf8("WorldClockWidget"));
        ...
        val2->setFont(font1);
        val2->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);\n"
"color: black;\n"
"border-radius: 6px;"));
        ...
        val3->setFont(font1);
        val3->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);\n"
"color: black;\n"
"border-radius: 6px;"));
        ...
        val5->setFont(font1);
        val5->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);\n"
"color: black;\n"
"border-radius: 6px;"));
        ...
        val6->setFont(font1);
        val6->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);\n"
"color: black;\n"
"border-radius: 6px;"));
        ...
        val4->setFont(font1);
        val4->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);\n"
"color: black;\n"
"border-radius: 6px;"));
        ...
        val1->setFont(font1);
        val1->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);\n"
"color: black;\n"
"border-radius: 6px;"));
