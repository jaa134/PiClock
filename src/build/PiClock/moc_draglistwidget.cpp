...
#include "../../App/PiClock/settingsPage/draglistwidget.h"
...
QT_INIT_METAOBJECT const QMetaObject DragListWidget::staticMetaObject = { {
    &QListWidget::staticMetaObject,
    qt_meta_stringdata_DragListWidget.data,
    qt_meta_data_DragListWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
