...
#include "../../App/PiClock/alarmPage/alarmmanager.h"
...
QT_MOC_LITERAL(1, 13, 10), // "alarmStart"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 9), // "alarmStop"
QT_MOC_LITERAL(4, 35, 10), // "startAlarm"
QT_MOC_LITERAL(5, 46, 9) // "stopAlarm"

    },
    "AlarmManager\0alarmStart\0\0alarmStop\0"
    "startAlarm\0stopAlarm"
};
...
void AlarmManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->alarmStart(); break;
        case 1: _t->alarmStop(); break;
        case 2: _t->startAlarm(); break;
        case 3: _t->stopAlarm(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AlarmManager::alarmStart)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (AlarmManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AlarmManager::alarmStop)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject AlarmManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_AlarmManager.data,
      qt_meta_data_AlarmManager,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void AlarmManager::alarmStart()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void AlarmManager::alarmStop()
{
