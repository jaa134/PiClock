...
QT_MOC_LITERAL(1, 10, 14), // "changeDateTime"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 5), // "start"
QT_MOC_LITERAL(4, 32, 4), // "stop"
QT_MOC_LITERAL(5, 37, 14) // "updateDateTime"

    },
    "MainClock\0changeDateTime\0\0start\0stop\0"
    "updateDateTime"
};
...
void MainClock::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MainClock *_t = static_cast<MainClock *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (MainClock::*)(QString , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainClock::changeDateTime)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MainClock::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MainClock.data,
      qt_meta_data_MainClock,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void MainClock::changeDateTime(QString _t1, QString _t2)
{
